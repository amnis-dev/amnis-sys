export const managerLocale = {
  ...
  'manager.speeddial.localization': 'Localization',
  'manager.speeddial.manager': 'Manager',
  'manager.speeddial.save': 'Save',

  'manager.state_data_select_button': 'Data Select',
  'manager.state_data_select_chip': 'Data Selection Mode',
  'manager.state_component_select_button': 'Component Select',
  'manager.state_component_select_chip': 'Component Selection Mode',
